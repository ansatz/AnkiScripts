...
if PYQT5:
    ...
    #from krop.mwui_qt5 import Ui_MainWindow
else:
...
class MainWindow(QKMainWindow):
    ...
    def __init__(self):
        ...
        #
        self.ui.actionAddAnki.setIcon(QIcon.fromTheme('zoom-in'))
        ...
        #
        self.ui.actionAddAnki.triggered.connect(self.slotAddAnki)
    ...
    QFilesettings.setValue("Trim/AllowedChanges",
    ...
    def openFile(self, fileName):
        if fileName:
            ...
            #
            self.ui.actionAddAnki.setEnabled(not self.viewer.isEmpty())
